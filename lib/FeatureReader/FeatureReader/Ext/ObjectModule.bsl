...
Функция ПеревестиТекстПоТаблицеПеревода(ДанныеПеревода)
	...
	Если ДанныеПеревода.КлючевыеСловаПеревод <> Неопределено Тогда
	    ТаблицаКлючевыхСловПеревод = ДанныеПеревода.КлючевыеСловаПеревод.ТаблицаКлючевыхСлов;
	Иначе
	    // Для исходного языка используем оригинальную таблицу
	    ТаблицаКлючевыхСловПеревод = ДанныеПеревода.КлючевыеСловаОригинал.ТаблицаКлючевыхСлов;
	КонецЕсли;
	...
	Для Ккк = 0 По МассивСтрок.Количество()-1 Цикл
		...
		Если ТекущийЯзыкФичаФайла <> "ru" И ДанныеПеревода.ЯзыкПеревода = "ru" Тогда
