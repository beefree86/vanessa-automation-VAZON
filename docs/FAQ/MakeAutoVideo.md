...
3. Особенности
   * Используйте теги #[autodoc.groupsteps] для группировки в цикле шагов вместо объявления группы * Группа уровня 1
   * Используйте теги #[autodoc.ignorestep], в т.ч. перед #[autodoc.groupsteps] для минимизации "воздуха" в видео
