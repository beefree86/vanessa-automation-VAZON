...
8. На CI сервере скриншот формируется, но вместо изображения чёрный экран. Как настроить сервер CI?
	...
	* Для исключения черного экрана при работе автотестов через RDP необходимо корректно завершать RDP-сессию, переключая ее на локальную консоль. Корректное переключение RDP-сессии на локальную консоль.

	При закрытии окна RDP сеанс переходит в состояние «отключено», графическая оболочка перестает выводиться, и на скриншотах появляется черный экран. Чтобы сохранить активную графическую среду, требуется перевести текущий сеанс на локальную консоль.
	...
	``` 
	После выполнения команда корректно отключает RDP, сохраняя при этом активную графическую среду на локальной консоли. Это обеспечивает корректное разрешение экрана и исключает проблему черного экрана на скриншотах во время автотестов.
