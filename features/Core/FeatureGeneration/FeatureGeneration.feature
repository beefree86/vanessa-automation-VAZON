...
Сценарий: Выбор определенных объектов метаданных и генерация сценариев с обновлением фича-файлов
	...
	* Формирование структуры метаданных
		...
		Тогда таблица 'ДеревоМетаданных' стала равной:
			...
			| 'Нет'     | 'Регистры сведений'         | 'РегистрСведений'        | 'Да'                    | 'Да'                   | 'Нет'                               | 'Нет'                                      | 'Нет'               | 'Нет'    |
			| 'Нет'     | 'Обработки'                 | 'Обработка'              | 'Да'                    | 'Нет'                  | 'Нет'                               | 'Нет'                                      | 'Нет'               | 'Нет'    |
			| 'Нет'     | 'Регистры расчета'          | 'РегистрБухгалтерии'     | 'Нет'                   | 'Да'                   | 'Нет'                               | 'Нет'                                      | 'Нет'               | 'Нет'    |
			| 'Нет'     | 'Журналы документов'        | 'ЖурналДокументов'       | 'Да'                    | 'Нет'                  | 'Нет'                               | 'Нет'                                      | 'Нет'               | 'Нет'    |
			| 'Нет'     | 'Регистры бухгалтерии'      | 'РегистрБухгалтерии'     | 'Нет'                   | 'Да'                   | 'Нет'                               | 'Нет'                                      | 'Нет'               | 'Нет'    |
			| 'Нет'     | 'Регистры накопления'       | 'РегистрНакопления'      | 'Нет'                   | 'Да'                   | 'Нет'                               | 'Нет'                                      | 'Нет'               | 'Нет'    |
			| 'Нет'     | 'Планы видов Расчета'       | 'ПланВидовРасчета'       | 'Да'                    | 'Да'                   | 'Да'                                | 'Да'                                       | 'Нет'               | 'Нет'    |
			| 'Нет'     | 'Планы счетов'              | 'ПланСчетов'             | 'Да'                    | 'Да'                   | 'Да'                                | 'Нет'                                      | 'Нет'               | 'Нет'    |
			| 'Нет'     | 'Отчеты'                    | 'Отчет'                  | 'Да'                    | 'Нет'                  | 'Нет'                               | 'Нет'                                      | 'Нет'               | 'Нет'    |
			| 'Нет'     | 'Планы видов характеристик' | 'ПланВидовХарактеристик' | 'Да'                    | 'Да'                   | 'Да'                                | 'Да'                                       | 'Нет'               | 'Нет'    |
...
Сценарий: Проверка создания новых фича-файлов
	...
	* Проверка создания фича-файлов
		Тогда в логе сообщений TestClient есть строки по шаблону:
			|'*: Создан новый feature-файл: 113_Документы_Запись.feature'|
			|'*: Создан новый feature-файл: 114_Документы_Копирование.feature'|
			|'*: Файлы успешно обновлены.'|
