...
Сценарий: я делаю подсветку текста в редакторе VA в режиме обучения в строке "НомерСтроки" "Подсказка" подсценарий
		И я делаю подсветку текста в редакторе VA в режиме обучения в строке "НомерСтроки" "Подсказка"
		И Пауза 1
		@screenshot
		И Пауза 0.1
		И Пауза 3
...
Сценарий: я делаю подсветку пункта контекстного меню редактора "ИмяЭлемента" "Текст"
...
Сценарий: я делаю подсветку элемента с ID 'IDЭлемента' 'Текст'
	И я делаю эффект затемнения у элементов формы UI Automation "ЭтотСеанс"
		| 'Имя/ID'     | 'Тип' |
		| 'IDЭлемента' | ''    |
...
Сценарий: я делаю подсветку элемента с заголовоком и типом 'IDЭлемента' 'ТипЭлемента' 'Текст'
	И я делаю эффект затемнения у элементов формы UI Automation "ЭтотСеанс"
		| 'Имя/ID'     | 'Тип'         |
		| 'IDЭлемента' | 'ТипЭлемента' |
...
Сценарий: Я делаю подсветку у табло переменных VA "Текст"
...
Сценарий: Я делаю подсветку у поля с заголовком "Заголовок" типом "ТипПоля" "Текст" UI Automation подсценарий
		И я делаю эффект затемнения у элементов формы UI Automation "ЭтотСеанс"
			| 'Имя/ID'    | 'Тип'     |
			| 'Заголовок' | 'ТипПоля' |
...
Сценарий: я делаю подсветку элемента выпадающего списка VA "ИмяЭлемента" "Текст"
	И я перемещаю курсор к элементу формы  'ЭтотСеанс' 'ИмяЭлемента' '' UI Automation
	И Пауза 1
	И я делаю эффект затемнения у элементов формы UI Automation "ЭтотСеанс"
		| 'Имя/ID'      | 'Тип' |
		| 'ИмяЭлемента' | ''    |
...
Сценарий: я перемещаю курсор мышки к тексту в строке редактора "НомерСтроки" VA в режиме обучения подсценарий
		И я перемещаю курсор мышки к тексту в строке редактора "НомерСтроки" VA в режиме обучения
		И Пауза 2
		@screenshot
		И Пауза 0.1
		И Пауза 1
...
Сценарий: я делаю подсветку текста данного шага в сеансе VA в режиме обучения подсценарий
