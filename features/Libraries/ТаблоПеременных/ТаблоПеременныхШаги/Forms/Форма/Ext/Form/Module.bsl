...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
    ...
    Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯЗагружаюИзСистемыОтката(Парам01)",
		...
		"Загружает из системы отката ищет последнюю закладку по наименованию(ИмяЗакладки).",
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯВыгружаюВСистемуОтката(Парам01)",
		...
		"Загружает в систему отаката текущее состояние табло с наименованием(ИмяЗакладки).",
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯУдаляюИзСистемыОтката(Парам01)",
		...
		"Удаляет закладку с наименованием(ИмяЗакладки) из системы отката.",
