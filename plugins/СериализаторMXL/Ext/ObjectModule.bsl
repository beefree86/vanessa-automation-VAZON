...
Функция ДобавитьРеквизитОбъектаВВыгрузку(ДанныеДляВыгрузки, МассивДанных, Объект, РеквизитМд, ЗначениеРеквизита, Мд, ШапкаДанных)
	...
	// Используем ленивую проверку, сначала проверяем имя реквизита, так как объект может не иметь свойства Предопределенный.
	// 
	Если ЗаписьВыгрузки.Реквизит = "Ссылка" И Объект.Предопределенный Тогда
		Возврат Истина;
	КонецЕсли;
